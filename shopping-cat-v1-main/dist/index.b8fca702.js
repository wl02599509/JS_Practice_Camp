...
btn.forEach((elm)=>elm.addEventListener("click", function(e) {
        ...
        if (document.querySelector(`#${catName}`)) document.querySelector(`#${catName}`).remove();
...
const removeBtnIcon = (e)=>{
    e.target.parentNode.parentNode.parentNode.remove();
};
removeItem.forEach(function(btn1) {
    btn1.addEventListener("click", removeBtn);
});
removeItemIcon.forEach(function(btn2) {
    btn2.addEventListener("click", removeBtnIcon);
});
//總價顯示
const total = document.querySelector(".total-price");
const sum = document.querySelectorAll(".sum");

},{"bootstrap/dist/css/bootstrap.css":"jJvnD","@fortawesome/fontawesome-free/css/all.css":"8OILE"}],"jJvnD":[function() {},{}],"8OILE":[function() {},{}]},["7age3","3cYfC"], "3cYfC", "parcelRequirefe43")
